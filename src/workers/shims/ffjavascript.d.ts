/**
 * Module declaration for ffjavascript (shimmed for Workers)
 * This allows TypeScript to compile @zk-kit/groth16 source with our alias
 */
declare module 'ffjavascript' {
    ...
    export namespace Scalar {
        ...
        function toRprLE(buffer: Uint8Array, offset: number, value: string | number | bigint, len?: number): void;
        function fromRprBE(buffer: Uint8Array, offset?: number, len?: number): bigint;
        function toRprBE(buffer: Uint8Array, offset: number, value: string | number | bigint, len?: number): void;
